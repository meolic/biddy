/**CFile*******************************************************************
  ...
  Date        [$Date: 2022-12-30 21:37:33 +0100 (pet, 30 dec 2022) $]
...
/* 127 Biddy_Managed_CountMinterms */
