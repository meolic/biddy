...
typedef struct BddscoutStubs {
    ...
    Biddy_Edge (*biddy_Managed_Product) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 101 */
    Biddy_Edge (*biddy_Managed_SelectiveProduct) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Edge cube); /* 102 */
    Biddy_Edge (*biddy_Managed_Supset) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 103 */
    Biddy_Edge (*biddy_Managed_Subset) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 104 */
    Biddy_Edge (*biddy_Managed_Permitsym) (Biddy_Manager MNG, Biddy_Edge f, unsigned int n); /* 105 */
    Biddy_Edge (*biddy_Managed_Stretch) (Biddy_Manager MNG, Biddy_Edge f); /* 106 */
    Biddy_Edge (*biddy_Managed_CreateMinterm) (Biddy_Manager MNG, Biddy_Edge support, long long unsigned int x); /* 107 */
    Biddy_Edge (*biddy_Managed_CreateFunction) (Biddy_Manager MNG, Biddy_Edge support, long long unsigned int x); /* 108 */
    Biddy_Edge (*biddy_Managed_RandomFunction) (Biddy_Manager MNG, Biddy_Edge support, double r); /* 109 */
    Biddy_Edge (*biddy_Managed_RandomSet) (Biddy_Manager MNG, Biddy_Edge empty, double r); /* 110 */
    Biddy_Edge (*biddy_Managed_ExtractMinterm) (Biddy_Manager MNG, Biddy_Edge support, Biddy_Edge f); /* 111 */
    Biddy_Edge (*biddy_Managed_Dual) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean neg); /* 112 */

    unsigned int (*biddy_Managed_CountNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 113 */
    unsigned int (*biddy_MaxLevel) (Biddy_Edge f); /* 114 */
    float (*biddy_AvgLevel) (Biddy_Edge f); /* 115 */
    unsigned int (*biddy_Managed_SystemStat) (Biddy_Manager MNG, unsigned int stat); /* 116 */
    unsigned long long int (*biddy_Managed_SystemLongStat) (Biddy_Manager MNG, unsigned int longstat); /* 117 */
    unsigned int (*biddy_Managed_NodeTableNumVar) (Biddy_Manager MNG, Biddy_Variable v); /* 118 */
    unsigned long long int (*biddy_Managed_NodeTableGCObsoleteNumber) (Biddy_Manager MNG); /* 119 */
    unsigned int (*biddy_Managed_ListUsed) (Biddy_Manager MNG); /* 120 */
    unsigned int (*biddy_Managed_ListMaxLength) (Biddy_Manager MNG); /* 121 */
    float (*biddy_Managed_ListAvgLength) (Biddy_Manager MNG); /* 122 */
    unsigned int (*biddy_Managed_CountNodesPlain) (Biddy_Manager MNG, Biddy_Edge f); /* 123 */
    unsigned int (*biddy_Managed_DependentVariableNumber) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean select); /* 124 */
    unsigned int (*biddy_Managed_CountComplementedEdges) (Biddy_Manager MNG, Biddy_Edge f); /* 125 */
    unsigned long long int (*biddy_Managed_CountPaths) (Biddy_Manager MNG, Biddy_Edge f); /* 126 */
    double (*biddy_Managed_CountMinterms) (Biddy_Manager MNG, Biddy_Edge f, int nvars); /* 127 */
    double (*biddy_Managed_DensityOfFunction) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 128 */
    double (*biddy_Managed_DensityOfBDD) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 129 */
    unsigned int (*biddy_Managed_MinNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 130 */
    unsigned int (*biddy_Managed_MaxNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 131 */
    unsigned long long int (*biddy_Managed_ReadMemoryInUse) (Biddy_Manager MNG); /* 132 */
    void (*biddy_Managed_PrintInfo) (Biddy_Manager MNG, FILE *f); /* 133 */

    Biddy_String (*biddy_Managed_Eval0) (Biddy_Manager MNG, Biddy_String s); /* 134 */
    Biddy_Edge (*biddy_Managed_Eval1x) (Biddy_Manager MNG, Biddy_String s, Biddy_LookupFunction lf); /* 135 */
    Biddy_Edge (*biddy_Managed_Eval2) (Biddy_Manager MNG, Biddy_String boolFunc); /* 136 */
    Biddy_String (*biddy_Managed_ReadBddview) (Biddy_Manager MNG, const char filename[], Biddy_String name); /* 137 */
    void (*biddy_Managed_ReadVerilogFile) (Biddy_Manager MNG, const char filename[], Biddy_String prefix); /* 138 */
    void (*biddy_Managed_PrintBDD) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f, Biddy_String label); /* 139 */
    void (*biddy_Managed_PrintTable) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f); /* 140 */
    void (*biddy_Managed_PrintSOP) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f); /* 141 */
    void (*biddy_Managed_PrintMinterms) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f, Biddy_Boolean negative); /* 142 */
    unsigned int (*biddy_Managed_WriteDot) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], int id, Biddy_Boolean cudd); /* 143 */
    unsigned int (*biddy_Managed_WriteBddview) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], void *table); /* 144 */
...
#define Biddy_Managed_Product \
    (bddscoutStubsPtr->biddy_Managed_Product) /* 101 */
#define Biddy_Managed_SelectiveProduct \
    (bddscoutStubsPtr->biddy_Managed_SelectiveProduct) /* 102 */
#define Biddy_Managed_Supset \
    (bddscoutStubsPtr->biddy_Managed_Supset) /* 103 */
#define Biddy_Managed_Subset \
    (bddscoutStubsPtr->biddy_Managed_Subset) /* 104 */
#define Biddy_Managed_Permitsym \
    (bddscoutStubsPtr->biddy_Managed_Permitsym) /* 105 */
#define Biddy_Managed_Stretch \
    (bddscoutStubsPtr->biddy_Managed_Stretch) /* 106 */
#define Biddy_Managed_CreateMinterm \
    (bddscoutStubsPtr->biddy_Managed_CreateMinterm) /* 107 */
#define Biddy_Managed_CreateFunction \
    (bddscoutStubsPtr->biddy_Managed_CreateFunction) /* 108 */
#define Biddy_Managed_RandomFunction \
    (bddscoutStubsPtr->biddy_Managed_RandomFunction) /* 109 */
#define Biddy_Managed_RandomSet \
    (bddscoutStubsPtr->biddy_Managed_RandomSet) /* 110 */
#define Biddy_Managed_ExtractMinterm \
    (bddscoutStubsPtr->biddy_Managed_ExtractMinterm) /* 111 */
#define Biddy_Managed_Dual \
    (bddscoutStubsPtr->biddy_Managed_Dual) /* 112 */

#define Biddy_Managed_CountNodes \
    (bddscoutStubsPtr->biddy_Managed_CountNodes) /* 113 */
#define Biddy_MaxLevel \
    (bddscoutStubsPtr->biddy_MaxLevel) /* 114 */
#define Biddy_AvgLevel \
    (bddscoutStubsPtr->biddy_AvgLevel) /* 115 */
#define Biddy_Managed_SystemStat \
    (bddscoutStubsPtr->biddy_Managed_SystemStat) /* 116 */
#define Biddy_Managed_SystemLongStat \
    (bddscoutStubsPtr->biddy_Managed_SystemLongStat) /* 117 */
#define Biddy_Managed_NodeTableNumVar \
    (bddscoutStubsPtr->biddy_Managed_NodeTableNumVar) /* 118 */
...
#define Biddy_Managed_ListUsed \
    (bddscoutStubsPtr->biddy_Managed_ListUsed) /* 120 */
#define Biddy_Managed_ListMaxLength \
    (bddscoutStubsPtr->biddy_Managed_ListMaxLength) /* 121 */
#define Biddy_Managed_ListAvgLength \
    (bddscoutStubsPtr->biddy_Managed_ListAvgLength) /* 122 */
#define Biddy_Managed_CountNodesPlain \
    (bddscoutStubsPtr->biddy_Managed_CountNodesPlain) /* 123 */
#define Biddy_Managed_DependentVariableNumber \
    (bddscoutStubsPtr->biddy_Managed_DependentVariableNumber) /* 124 */
#define Biddy_Managed_CountComplementedEdges \
    (bddscoutStubsPtr->biddy_Managed_CountComplementedEdges) /* 125 */
#define Biddy_Managed_CountPaths \
    (bddscoutStubsPtr->biddy_Managed_CountPaths) /* 126 */
#define Biddy_Managed_CountMinterms \
    (bddscoutStubsPtr->biddy_Managed_CountMinterms) /* 127 */
#define Biddy_Managed_DensityOfFunction \
    (bddscoutStubsPtr->biddy_Managed_DensityOfFunction) /* 128 */
#define Biddy_Managed_DensityOfBDD \
    (bddscoutStubsPtr->biddy_Managed_DensityOfBDD) /* 129 */
#define Biddy_Managed_MinNodes \
    (bddscoutStubsPtr->biddy_Managed_MinNodes) /* 130 */
#define Biddy_Managed_MaxNodes \
    (bddscoutStubsPtr->biddy_Managed_MaxNodes) /* 131 */
#define Biddy_Managed_ReadMemoryInUse \
    (bddscoutStubsPtr->biddy_Managed_ReadMemoryInUse) /* 132 */
#define Biddy_Managed_PrintInfo \
    (bddscoutStubsPtr->biddy_Managed_PrintInfo) /* 133 */

#define Biddy_Managed_Eval0 \
    (bddscoutStubsPtr->biddy_Managed_Eval0) /* 134 */
#define Biddy_Managed_Eval1x \
    (bddscoutStubsPtr->biddy_Managed_Eval1x) /* 135 */
#define Biddy_Managed_Eval2 \
    (bddscoutStubsPtr->biddy_Managed_Eval2) /* 136 */
#define Biddy_Managed_ReadBddview\
    (bddscoutStubsPtr->biddy_Managed_ReadBddview) /* 137 */
#define Biddy_Managed_ReadVerilogFile\
    (bddscoutStubsPtr->biddy_Managed_ReadVerilogFile) /* 138 */
#define Biddy_Managed_PrintBDD\
    (bddscoutStubsPtr->biddy_Managed_PrintBDD) /* 139 */
#define Biddy_Managed_PrintTable \
    (bddscoutStubsPtr->biddy_Managed_PrintTable) /* 140 */
#define Biddy_Managed_PrintSOP \
    (bddscoutStubsPtr->biddy_Managed_PrintSOP) /* 141 */
#define Biddy_Managed_PrintMinterms \
    (bddscoutStubsPtr->biddy_Managed_PrintMinterms) /* 142 */
#define Biddy_Managed_WriteDot \
    (bddscoutStubsPtr->biddy_Managed_WriteDot) /* 143 */
#define Biddy_Managed_WriteBddview \
    (bddscoutStubsPtr->biddy_Managed_WriteBddview) /* 144 */
