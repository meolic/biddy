/**CHeaderFile*************************************************************
  ...
  Date        [$Date: 2020-03-01 18:33:49 +0100 (ned, 01 mar 2020) $]
...
typedef struct BddscoutStubs {
    ...
    Biddy_Edge (*biddy_Managed_ExtractMinterm) (Biddy_Manager MNG, Biddy_Edge f); /* 111 */
    ...
    double (*biddy_Managed_CountMinterms) (Biddy_Manager MNG, Biddy_Edge f, int nvars); /* 126 */
