...
typedef struct BddscoutStubs {
    ...
    Biddy_Edge (*biddy_Managed_XYCompose) (Biddy_Manager MNG, Biddy_Edge f); /* 88 */
    Biddy_Edge (*biddy_Managed_E) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 89 */
    Biddy_Edge (*biddy_Managed_A) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 90 */
    Biddy_Boolean (*biddy_Managed_IsVariableDependent) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 91 */
    Biddy_Edge (*biddy_Managed_ExistAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge cube); /* 92 */
    Biddy_Edge (*biddy_Managed_ExistAndAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Edge cube); /* 93 */
    Biddy_Edge (*biddy_Managed_UnivAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge cube); /* 94 */
    Biddy_Edge (*biddy_Managed_DiffAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge cube); /* 95 */
    Biddy_Edge (*biddy_Managed_YesNoAbstract) (Biddy_Manager MNG, Biddy_Boolean type, Biddy_Edge f, Biddy_Edge cube); /* 96 */
    Biddy_Edge (*biddy_Managed_Constrain) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge c); /* 97 */
    Biddy_Edge (*biddy_Managed_Simplify) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge c); /* 98 */
    Biddy_Edge (*biddy_Managed_Median) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Edge h); /* 99 */
    Biddy_Edge (*biddy_Managed_Support) (Biddy_Manager MNG, Biddy_Edge f); /* 100 */
    Biddy_Edge (*biddy_Managed_ReplaceByKeyword) (Biddy_Manager MNG, Biddy_Edge f, Biddy_String keyword); /* 101 */
    Biddy_Edge (*biddy_Managed_Change) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 102 */
    Biddy_Edge (*biddy_Managed_VarSubset) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v, Biddy_Boolean value); /* 103 */
    Biddy_Edge (*biddy_Managed_ElementAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 104 */
    Biddy_Edge (*biddy_Managed_Product) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 105 */
    Biddy_Edge (*biddy_Managed_SelectiveProduct) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Edge cube); /* 106 */
    Biddy_Edge (*biddy_Managed_Supset) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 107 */
    Biddy_Edge (*biddy_Managed_Subset) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 108 */
    Biddy_Edge (*biddy_Managed_Permitsym) (Biddy_Manager MNG, Biddy_Edge f, unsigned int n); /* 109 */
    Biddy_Edge (*biddy_Managed_Stretch) (Biddy_Manager MNG, Biddy_Edge f); /* 110 */
    Biddy_Edge (*biddy_Managed_CreateMinterm) (Biddy_Manager MNG, Biddy_Edge support, long long unsigned int x); /* 111 */
    Biddy_Edge (*biddy_Managed_CreateFunction) (Biddy_Manager MNG, Biddy_Edge support, long long unsigned int x); /* 112 */
    Biddy_Edge (*biddy_Managed_RandomFunction) (Biddy_Manager MNG, Biddy_Edge support, double r); /* 113 */
    Biddy_Edge (*biddy_Managed_RandomSet) (Biddy_Manager MNG, Biddy_Edge empty, double r); /* 114 */
    Biddy_Edge (*biddy_Managed_ExtractMinterm) (Biddy_Manager MNG, Biddy_Edge support, Biddy_Edge f); /* 115 */
    Biddy_Edge (*biddy_Managed_Dual) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean neg); /* 116 */

    unsigned int (*biddy_Managed_CountNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 117 */
    unsigned int (*biddy_MaxLevel) (Biddy_Edge f); /* 118 */
    float (*biddy_AvgLevel) (Biddy_Edge f); /* 119 */
    unsigned int (*biddy_Managed_SystemStat) (Biddy_Manager MNG, unsigned int stat); /* 120 */
    unsigned long long int (*biddy_Managed_SystemLongStat) (Biddy_Manager MNG, unsigned int longstat); /* 121 */
    unsigned int (*biddy_Managed_NodeTableNumVar) (Biddy_Manager MNG, Biddy_Variable v); /* 122 */
    unsigned long long int (*biddy_Managed_NodeTableGCObsoleteNumber) (Biddy_Manager MNG); /* 123 */
    unsigned int (*biddy_Managed_ListUsed) (Biddy_Manager MNG); /* 124 */
    unsigned int (*biddy_Managed_ListMaxLength) (Biddy_Manager MNG); /* 125 */
    float (*biddy_Managed_ListAvgLength) (Biddy_Manager MNG); /* 126 */
    unsigned int (*biddy_Managed_CountNodesPlain) (Biddy_Manager MNG, Biddy_Edge f); /* 127 */
    unsigned int (*biddy_Managed_DependentVariableNumber) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean select); /* 128 */
    unsigned int (*biddy_Managed_CountComplementedEdges) (Biddy_Manager MNG, Biddy_Edge f); /* 129 */
    unsigned long long int (*biddy_Managed_CountPaths) (Biddy_Manager MNG, Biddy_Edge f); /* 130 */
    double (*biddy_Managed_CountMinterms) (Biddy_Manager MNG, Biddy_Edge f, int nvars); /* 131 */
    double (*biddy_Managed_DensityOfFunction) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 132 */
    double (*biddy_Managed_DensityOfBDD) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 133 */
    unsigned int (*biddy_Managed_MinNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 134 */
    unsigned int (*biddy_Managed_MaxNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 135 */
    unsigned long long int (*biddy_Managed_ReadMemoryInUse) (Biddy_Manager MNG); /* 136 */
    void (*biddy_Managed_PrintInfo) (Biddy_Manager MNG, FILE *f); /* 137 */

    Biddy_String (*biddy_Managed_Eval0) (Biddy_Manager MNG, Biddy_String s); /* 138 */
    Biddy_Edge (*biddy_Managed_Eval1x) (Biddy_Manager MNG, Biddy_String s, Biddy_LookupFunction lf); /* 139 */
    Biddy_Edge (*biddy_Managed_Eval2) (Biddy_Manager MNG, Biddy_String boolFunc); /* 140 */
    Biddy_Edge (*biddy_Managed_Eval3) (Biddy_Manager MNG, Biddy_String *name, Biddy_String bddlString); /* 141 */
    Biddy_String (*biddy_Managed_ReadBddview) (Biddy_Manager MNG, const char filename[], Biddy_String name); /* 142 */
    void (*biddy_Managed_ReadVerilogFile) (Biddy_Manager MNG, const char filename[], Biddy_String prefix); /* 143 */
    Biddy_String (*biddy_Managed_ReadBDDLFile) (Biddy_Manager MNG, const char filename[]); /* 144 */
    void (*biddy_Managed_PrintBDD) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f, Biddy_String label); /* 145 */
    void (*biddy_Managed_PrintTable) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f); /* 146 */
    void (*biddy_Managed_PrintSOP) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f); /* 147 */
    void (*biddy_Managed_PrintMinterms) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f, Biddy_Boolean negative); /* 148 */
    unsigned int (*biddy_Managed_WriteDot) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], int id, Biddy_Boolean cudd); /* 149 */
    unsigned int (*biddy_Managed_WriteBddview) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], void *table); /* 150 */
...
#define Biddy_Managed_XYCompose \
    (bddscoutStubsPtr->biddy_Managed_XYCompose) /* 88 */
#define Biddy_Managed_E \
    (bddscoutStubsPtr->biddy_Managed_E) /* 89 */
#define Biddy_Managed_A \
    (bddscoutStubsPtr->biddy_Managed_A) /* 90 */
#define Biddy_Managed_IsVariableDependent \
    (bddscoutStubsPtr->biddy_Managed_IsVariableDependent) /* 91 */
#define Biddy_Managed_ExistAbstract \
    (bddscoutStubsPtr->biddy_Managed_ExistAbstract) /* 92 */
#define Biddy_Managed_ExistAndAbstract \
    (bddscoutStubsPtr->biddy_Managed_ExistAndAbstract) /* 93 */
#define Biddy_Managed_UnivAbstract \
    (bddscoutStubsPtr->biddy_Managed_UnivAbstract) /* 94 */
#define Biddy_Managed_DiffAbstract \
    (bddscoutStubsPtr->biddy_Managed_DiffAbstract) /* 95 */
#define Biddy_Managed_YesNoAbstract \
    (bddscoutStubsPtr->biddy_Managed_YesNoAbstract) /* 96 */
#define Biddy_Managed_Constrain \
    (bddscoutStubsPtr->biddy_Managed_Constrain) /* 97 */
#define Biddy_Managed_Simplify \
    (bddscoutStubsPtr->biddy_Managed_Simplify) /* 98 */
#define Biddy_Managed_Median \
    (bddscoutStubsPtr->biddy_Managed_Median) /* 99 */
#define Biddy_Managed_Support \
    (bddscoutStubsPtr->biddy_Managed_Support) /* 100 */
#define Biddy_Managed_ReplaceByKeyword \
    (bddscoutStubsPtr->biddy_Managed_ReplaceByKeyword) /* 101 */
#define Biddy_Managed_Change \
    (bddscoutStubsPtr->biddy_Managed_Change) /* 102 */
#define Biddy_Managed_VarSubset \
    (bddscoutStubsPtr->biddy_Managed_VarSubset) /* 103 */
#define Biddy_Managed_ElementAbstract \
    (bddscoutStubsPtr->biddy_Managed_ElementAbstract) /* 104 */
#define Biddy_Managed_Product \
    (bddscoutStubsPtr->biddy_Managed_Product) /* 105 */
#define Biddy_Managed_SelectiveProduct \
    (bddscoutStubsPtr->biddy_Managed_SelectiveProduct) /* 106 */
#define Biddy_Managed_Supset \
    (bddscoutStubsPtr->biddy_Managed_Supset) /* 107 */
#define Biddy_Managed_Subset \
    (bddscoutStubsPtr->biddy_Managed_Subset) /* 108 */
#define Biddy_Managed_Permitsym \
    (bddscoutStubsPtr->biddy_Managed_Permitsym) /* 109 */
#define Biddy_Managed_Stretch \
    (bddscoutStubsPtr->biddy_Managed_Stretch) /* 110 */
#define Biddy_Managed_CreateMinterm \
    (bddscoutStubsPtr->biddy_Managed_CreateMinterm) /* 111 */
#define Biddy_Managed_CreateFunction \
    (bddscoutStubsPtr->biddy_Managed_CreateFunction) /* 112 */
#define Biddy_Managed_RandomFunction \
    (bddscoutStubsPtr->biddy_Managed_RandomFunction) /* 113 */
#define Biddy_Managed_RandomSet \
    (bddscoutStubsPtr->biddy_Managed_RandomSet) /* 114 */
#define Biddy_Managed_ExtractMinterm \
    (bddscoutStubsPtr->biddy_Managed_ExtractMinterm) /* 115 */
#define Biddy_Managed_Dual \
    (bddscoutStubsPtr->biddy_Managed_Dual) /* 116 */

#define Biddy_Managed_CountNodes \
    (bddscoutStubsPtr->biddy_Managed_CountNodes) /* 117 */
#define Biddy_MaxLevel \
    (bddscoutStubsPtr->biddy_MaxLevel) /* 118 */
#define Biddy_AvgLevel \
    (bddscoutStubsPtr->biddy_AvgLevel) /* 119 */
#define Biddy_Managed_SystemStat \
    (bddscoutStubsPtr->biddy_Managed_SystemStat) /* 120 */
#define Biddy_Managed_SystemLongStat \
    (bddscoutStubsPtr->biddy_Managed_SystemLongStat) /* 121 */
#define Biddy_Managed_NodeTableNumVar \
    (bddscoutStubsPtr->biddy_Managed_NodeTableNumVar) /* 122 */
#define Biddy_Managed_NodeTableGCObsoleteNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableGCObsoleteNumber) /* 123 */
#define Biddy_Managed_ListUsed \
    (bddscoutStubsPtr->biddy_Managed_ListUsed) /* 124 */
#define Biddy_Managed_ListMaxLength \
    (bddscoutStubsPtr->biddy_Managed_ListMaxLength) /* 125 */
#define Biddy_Managed_ListAvgLength \
    (bddscoutStubsPtr->biddy_Managed_ListAvgLength) /* 126 */
#define Biddy_Managed_CountNodesPlain \
    (bddscoutStubsPtr->biddy_Managed_CountNodesPlain) /* 127 */
#define Biddy_Managed_DependentVariableNumber \
    (bddscoutStubsPtr->biddy_Managed_DependentVariableNumber) /* 128 */
#define Biddy_Managed_CountComplementedEdges \
    (bddscoutStubsPtr->biddy_Managed_CountComplementedEdges) /* 129 */
#define Biddy_Managed_CountPaths \
    (bddscoutStubsPtr->biddy_Managed_CountPaths) /* 130 */
#define Biddy_Managed_CountMinterms \
    (bddscoutStubsPtr->biddy_Managed_CountMinterms) /* 131 */
#define Biddy_Managed_DensityOfFunction \
    (bddscoutStubsPtr->biddy_Managed_DensityOfFunction) /* 132 */
#define Biddy_Managed_DensityOfBDD \
    (bddscoutStubsPtr->biddy_Managed_DensityOfBDD) /* 133 */
#define Biddy_Managed_MinNodes \
    (bddscoutStubsPtr->biddy_Managed_MinNodes) /* 134 */
#define Biddy_Managed_MaxNodes \
    (bddscoutStubsPtr->biddy_Managed_MaxNodes) /* 135 */
#define Biddy_Managed_ReadMemoryInUse \
    (bddscoutStubsPtr->biddy_Managed_ReadMemoryInUse) /* 136 */
#define Biddy_Managed_PrintInfo \
    (bddscoutStubsPtr->biddy_Managed_PrintInfo) /* 137 */

#define Biddy_Managed_Eval0 \
    (bddscoutStubsPtr->biddy_Managed_Eval0) /* 138 */
#define Biddy_Managed_Eval1x \
    (bddscoutStubsPtr->biddy_Managed_Eval1x) /* 139 */
#define Biddy_Managed_Eval2 \
    (bddscoutStubsPtr->biddy_Managed_Eval2) /* 140 */
#define Biddy_Managed_Eval3 \
    (bddscoutStubsPtr->biddy_Managed_Eval3) /* 141 */
#define Biddy_Managed_ReadBddview\
    (bddscoutStubsPtr->biddy_Managed_ReadBddview) /* 142 */
#define Biddy_Managed_ReadVerilogFile\
    (bddscoutStubsPtr->biddy_Managed_ReadVerilogFile) /* 143 */
#define Biddy_Managed_ReadBDDLFile\
    (bddscoutStubsPtr->biddy_Managed_ReadBDDLFile) /* 144 */
#define Biddy_Managed_PrintBDD\
    (bddscoutStubsPtr->biddy_Managed_PrintBDD) /* 145 */
#define Biddy_Managed_PrintTable \
    (bddscoutStubsPtr->biddy_Managed_PrintTable) /* 146 */
#define Biddy_Managed_PrintSOP \
    (bddscoutStubsPtr->biddy_Managed_PrintSOP) /* 147 */
#define Biddy_Managed_PrintMinterms \
    (bddscoutStubsPtr->biddy_Managed_PrintMinterms) /* 148 */
#define Biddy_Managed_WriteDot \
    (bddscoutStubsPtr->biddy_Managed_WriteDot) /* 149 */
#define Biddy_Managed_WriteBddview \
    (bddscoutStubsPtr->biddy_Managed_WriteBddview) /* 150 */
