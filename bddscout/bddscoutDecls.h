...
typedef struct BddscoutStubs {
    ...
    void (*biddy_Managed_SetAlphabeticOrdering) (Biddy_Manager MNG); /* 64 */
    Biddy_Variable (*biddy_Managed_SwapWithHigher) (Biddy_Manager MNG, Biddy_Variable v); /* 65 */
    Biddy_Variable (*biddy_Managed_SwapWithLower) (Biddy_Manager MNG, Biddy_Variable v); /* 66 */
    Biddy_Boolean (*biddy_Managed_Sifting) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean converge); /* 67 */
    void (*biddy_Managed_MinimizeBDD) (Biddy_Manager MNG, Biddy_String name); /* 68 */
    void (*biddy_Managed_MaximizeBDD) (Biddy_Manager MNG, Biddy_String name); /* 69 */
    Biddy_Edge (*biddy_Managed_Copy) (Biddy_Manager MNG1, Biddy_Manager MNG2, Biddy_Edge f); /* 70 */
    void (*biddy_Managed_CopyFormula) (Biddy_Manager MNG1, Biddy_Manager MNG2, Biddy_String x); /* 71 */
    Biddy_Edge (*biddy_Managed_ConstructBDD) (Biddy_Manager MNG, int numV, Biddy_String varlist, int numN, Biddy_String nodelist); /* 72 */

    Biddy_Edge (*biddy_Managed_Not) (Biddy_Manager MNG, Biddy_Edge f); /* 73 */
    Biddy_Edge (*biddy_Managed_ITE) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Edge h); /* 74 */
    Biddy_Edge (*biddy_Managed_And) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 75 */
    Biddy_Edge (*biddy_Managed_Or) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 76 */
    Biddy_Edge (*biddy_Managed_Nand) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 77 */
    Biddy_Edge (*biddy_Managed_Nor) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 78 */
    Biddy_Edge (*biddy_Managed_Xor) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 79 */
    Biddy_Edge (*biddy_Managed_Xnor) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 80 */
    Biddy_Edge (*biddy_Managed_Leq) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 81 */
    Biddy_Edge (*biddy_Managed_Gt) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 82 */
    Biddy_Boolean (*biddy_Managed_IsLeq) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g); /* 83 */
    Biddy_Edge (*biddy_Managed_Restrict) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v, Biddy_Boolean value); /* 84 */
    Biddy_Edge (*biddy_Managed_Compose) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Variable v); /* 85 */
    Biddy_Edge (*biddy_Managed_E) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 86 */
    Biddy_Edge (*biddy_Managed_A) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 87 */
    Biddy_Boolean (*biddy_Managed_IsVariableDependent) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 88 */
    Biddy_Edge (*biddy_Managed_ExistAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge cube); /* 89 */
    Biddy_Edge (*biddy_Managed_UnivAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge cube); /* 90 */
    Biddy_Edge (*biddy_Managed_AndAbstract) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge g, Biddy_Edge cube); /* 91 */
    Biddy_Edge (*biddy_Managed_Constrain) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge c); /* 92 */
    Biddy_Edge (*biddy_Managed_Simplify) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Edge c); /* 93 */
    Biddy_Edge (*biddy_Managed_Support) (Biddy_Manager MNG, Biddy_Edge f); /* 94 */
    Biddy_Edge (*biddy_Managed_ReplaceByKeyword) (Biddy_Manager MNG, Biddy_Edge f, Biddy_String keyword); /* 95 */
    Biddy_Edge (*biddy_Managed_Change) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v); /* 96 */
    Biddy_Edge (*biddy_Managed_Subset) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Variable v, Biddy_Boolean value); /* 97 */
    Biddy_Edge (*biddy_Managed_CreateMinterm) (Biddy_Manager MNG, Biddy_Edge support, long long unsigned int x); /* 98 */
    Biddy_Edge (*biddy_Managed_CreateFunction) (Biddy_Manager MNG, Biddy_Edge support, long long unsigned int x); /* 99 */
    Biddy_Edge (*biddy_Managed_RandomFunction) (Biddy_Manager MNG, Biddy_Edge support, double r); /* 100 */
    Biddy_Edge (*biddy_Managed_RandomSet) (Biddy_Manager MNG, Biddy_Edge empty, double r); /* 101 */

    unsigned int (*biddy_Managed_CountNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 102 */
    unsigned int (*biddy_MaxLevel) (Biddy_Edge f); /* 103 */
    float (*biddy_AvgLevel) (Biddy_Edge f); /* 104 */
    Biddy_Variable (*biddy_Managed_VariableTableNum) (Biddy_Manager MNG); /* 105 */
    unsigned int (*biddy_Managed_NodeTableSize) (Biddy_Manager MNG); /* 106 */
    unsigned int (*biddy_Managed_NodeTableBlockNumber) (Biddy_Manager MNG); /* 107 */
    unsigned int (*biddy_Managed_NodeTableGenerated) (Biddy_Manager MNG); /* 108 */
    unsigned int (*biddy_Managed_NodeTableMax) (Biddy_Manager MNG); /* 109 */
    unsigned int (*biddy_Managed_NodeTableNum) (Biddy_Manager MNG); /* 110 */
    unsigned int (*biddy_Managed_NodeTableNumVar) (Biddy_Manager MNG, Biddy_Variable v); /* 111 */
    unsigned int (*biddy_Managed_NodeTableResizeNumber) (Biddy_Manager MNG); /* 112 */
    unsigned long long int (*biddy_Managed_NodeTableFoaNumber) (Biddy_Manager MNG); /* 113 */
    unsigned long long int (*biddy_Managed_NodeTableFindNumber) (Biddy_Manager MNG); /* 114 */
    unsigned long long int (*biddy_Managed_NodeTableCompareNumber) (Biddy_Manager MNG); /* 115 */
    unsigned long long int (*biddy_Managed_NodeTableAddNumber) (Biddy_Manager MNG); /* 116 */
    unsigned int (*biddy_Managed_NodeTableGCNumber) (Biddy_Manager MNG); /* 117 */
    unsigned int (*biddy_Managed_NodeTableGCTime) (Biddy_Manager MNG); /* 118 */
    unsigned long long int (*biddy_Managed_NodeTableGCObsoleteNumber) (Biddy_Manager MNG); /* 119 */
    unsigned int (*biddy_Managed_NodeTableSwapNumber) (Biddy_Manager MNG); /* 120 */
    unsigned int (*biddy_Managed_NodeTableSiftingNumber) (Biddy_Manager MNG); /* 121 */
    unsigned int (*biddy_Managed_NodeTableDRTime) (Biddy_Manager MNG); /* 122 */
    unsigned int (*biddy_Managed_NodeTableITENumber) (Biddy_Manager MNG); /* 123 */
    unsigned long long int (*biddy_Managed_NodeTableITERecursiveNumber) (Biddy_Manager MNG); /* 124 */
    unsigned int (*biddy_Managed_NodeTableANDORNumber) (Biddy_Manager MNG); /* 125 */
    unsigned long long int (*biddy_Managed_NodeTableANDORRecursiveNumber) (Biddy_Manager MNG); /* 126 */
    unsigned int (*biddy_Managed_NodeTableXORNumber) (Biddy_Manager MNG); /* 127 */
    unsigned long long int (*biddy_Managed_NodeTableXORRecursiveNumber) (Biddy_Manager MNG); /* 128 */
    unsigned int (*biddy_Managed_FormulaTableNum) (Biddy_Manager MNG); /* 129 */
    unsigned int (*biddy_Managed_ListUsed) (Biddy_Manager MNG); /* 130 */
    unsigned int (*biddy_Managed_ListMaxLength) (Biddy_Manager MNG); /* 131 */
    float (*biddy_Managed_ListAvgLength) (Biddy_Manager MNG); /* 132 */
    unsigned long long int (*biddy_Managed_OPCacheSearch) (Biddy_Manager MNG); /* 133 */
    unsigned long long int (*biddy_Managed_OPCacheFind) (Biddy_Manager MNG); /* 134 */
    unsigned long long int (*biddy_Managed_OPCacheInsert) (Biddy_Manager MNG); /* 135 */
    unsigned long long int (*biddy_Managed_OPCacheOverwrite) (Biddy_Manager MNG); /* 136 */
    unsigned int (*biddy_Managed_CountNodesPlain) (Biddy_Manager MNG, Biddy_Edge f); /* 137 */
    unsigned int (*biddy_Managed_DependentVariableNumber) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean select); /* 138 */
    unsigned int (*biddy_Managed_CountComplementedEdges) (Biddy_Manager MNG, Biddy_Edge f); /* 139 */
    unsigned long long int (*biddy_Managed_CountPaths) (Biddy_Manager MNG, Biddy_Edge f); /* 140 */
    double (*biddy_Managed_CountMinterms) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 141 */
    double (*biddy_Managed_DensityOfFunction) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 142 */
    double (*biddy_Managed_DensityOfBDD) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 143 */
    unsigned int (*biddy_Managed_MinNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 144 */
    unsigned int (*biddy_Managed_MaxNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 145 */
    unsigned long long int (*biddy_Managed_ReadMemoryInUse) (Biddy_Manager MNG); /* 146 */
    void (*biddy_Managed_PrintInfo) (Biddy_Manager MNG, FILE *f); /* 147 */
    Biddy_String (*biddy_Managed_Eval0) (Biddy_Manager MNG, Biddy_String s); /* 148 */
    Biddy_Edge (*biddy_Managed_Eval1x) (Biddy_Manager MNG, Biddy_String s, Biddy_LookupFunction lf); /* 149 */
    Biddy_Edge (*biddy_Managed_Eval2) (Biddy_Manager MNG, Biddy_String boolFunc); /* 150 */
    Biddy_String (*biddy_Managed_ReadBddview) (Biddy_Manager MNG, const char filename[], Biddy_String name); /* 151 */
    void (*biddy_Managed_ReadVerilogFile) (Biddy_Manager MNG, const char filename[], Biddy_String prefix); /* 152 */
    void (*biddy_Managed_PrintfBDD) (Biddy_Manager MNG, Biddy_Edge f); /* 153 */
    void (*biddy_Managed_WriteBDD) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, Biddy_String label); /* 154 */
    void (*biddy_Managed_PrintfTable) (Biddy_Manager MNG, Biddy_Edge f); /* 155 */
    void (*biddy_Managed_WriteTable) (Biddy_Manager MNG, const char filename[], Biddy_Edge f); /* 156 */
    void (*biddy_Managed_PrintfSOP) (Biddy_Manager MNG, Biddy_Edge f); /* 157 */
    void (*biddy_Managed_WriteSOP) (Biddy_Manager MNG, const char filename[], Biddy_Edge f); /* 158 */
    unsigned int (*biddy_Managed_WriteDot) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], int id, Biddy_Boolean cudd); /* 159 */
    unsigned int (*biddy_Managed_WriteBddview) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], void *table); /* 160 */
...
#define Biddy_Managed_SetAlphabeticOrdering \
    (bddscoutStubsPtr->biddy_Managed_SetAlphabeticOrdering) /* 64 */
#define Biddy_Managed_SwapWithHigher \
    (bddscoutStubsPtr->biddy_Managed_SwapWithHigher) /* 65 */
#define Biddy_Managed_SwapWithLower \
    (bddscoutStubsPtr->biddy_Managed_SwapWithLower) /* 66 */
#define Biddy_Managed_Sifting \
    (bddscoutStubsPtr->biddy_Managed_Sifting) /* 67 */
#define Biddy_Managed_MinimizeBDD \
    (bddscoutStubsPtr->biddy_Managed_MinimizeBDD) /* 68 */
#define Biddy_Managed_MaximizeBDD \
    (bddscoutStubsPtr->biddy_Managed_MaximizeBDD) /* 69 */
#define Biddy_Managed_Copy \
    (bddscoutStubsPtr->biddy_Managed_Copy) /* 70 */
#define Biddy_Managed_CopyFormula \
    (bddscoutStubsPtr->biddy_Managed_CopyFormula) /* 71 */
#define Biddy_Managed_ConstructBDD \
    (bddscoutStubsPtr->biddy_Managed_ConstructBDD) /* 72 */

#define Biddy_Managed_Not \
    (bddscoutStubsPtr->biddy_Managed_Not) /* 73 */
#define Biddy_Managed_ITE \
    (bddscoutStubsPtr->biddy_Managed_ITE) /* 74 */
#define Biddy_Managed_And \
    (bddscoutStubsPtr->biddy_Managed_And) /* 75 */
#define Biddy_Managed_Or \
    (bddscoutStubsPtr->biddy_Managed_Or) /* 76 */
#define Biddy_Managed_Nand \
    (bddscoutStubsPtr->biddy_Managed_Nand) /* 77 */
#define Biddy_Managed_Nor \
    (bddscoutStubsPtr->biddy_Managed_Nor) /* 78 */
#define Biddy_Managed_Xor \
    (bddscoutStubsPtr->biddy_Managed_Xor) /* 79 */
#define Biddy_Managed_Xnor \
    (bddscoutStubsPtr->biddy_Managed_Xnor) /* 80 */
#define Biddy_Managed_Leq \
    (bddscoutStubsPtr->biddy_Managed_Leq) /* 81 */
#define Biddy_Managed_Gt \
    (bddscoutStubsPtr->biddy_Managed_Gt) /* 82 */
#define Biddy_Managed_IsLeq \
    (bddscoutStubsPtr->biddy_Managed_IsLeq) /* 83 */
#define Biddy_Managed_Restrict \
    (bddscoutStubsPtr->biddy_Managed_Restrict) /* 84 */
#define Biddy_Managed_Compose \
    (bddscoutStubsPtr->biddy_Managed_Compose) /* 85 */
#define Biddy_Managed_E \
    (bddscoutStubsPtr->biddy_Managed_E) /* 86 */
#define Biddy_Managed_A \
    (bddscoutStubsPtr->biddy_Managed_A) /* 87 */
#define Biddy_Managed_IsVariableDependent \
    (bddscoutStubsPtr->biddy_Managed_IsVariableDependent) /* 88 */
#define Biddy_Managed_ExistAbstract \
    (bddscoutStubsPtr->biddy_Managed_ExistAbstract) /* 89 */
#define Biddy_Managed_UnivAbstract \
    (bddscoutStubsPtr->biddy_Managed_UnivAbstract) /* 90 */
#define Biddy_Managed_AndAbstract \
    (bddscoutStubsPtr->biddy_Managed_AndAbstract) /* 91 */
#define Biddy_Managed_Constrain \
    (bddscoutStubsPtr->biddy_Managed_Constrain) /* 92 */
#define Biddy_Managed_Simplify \
    (bddscoutStubsPtr->biddy_Managed_Simplify) /* 93 */
#define Biddy_Managed_Support \
    (bddscoutStubsPtr->biddy_Managed_Support) /* 94 */
#define Biddy_Managed_ReplaceByKeyword \
    (bddscoutStubsPtr->biddy_Managed_ReplaceByKeyword) /* 95 */
#define Biddy_Managed_Change \
    (bddscoutStubsPtr->biddy_Managed_Change) /* 96 */
#define Biddy_Managed_Subset \
    (bddscoutStubsPtr->biddy_Managed_Subset) /* 97 */
#define Biddy_Managed_CreateMinterm \
    (bddscoutStubsPtr->biddy_Managed_CreateMinterm) /* 98 */
#define Biddy_Managed_CreateFunction \
    (bddscoutStubsPtr->biddy_Managed_CreateFunction) /* 99 */
#define Biddy_Managed_RandomFunction \
    (bddscoutStubsPtr->biddy_Managed_RandomFunction) /* 100 */
#define Biddy_Managed_RandomSet \
    (bddscoutStubsPtr->biddy_Managed_RandomSet) /* 101 */

#define Biddy_Managed_CountNodes \
    (bddscoutStubsPtr->biddy_Managed_CountNodes) /* 102 */
#define Biddy_MaxLevel \
    (bddscoutStubsPtr->biddy_MaxLevel) /* 103 */
#define Biddy_AvgLevel \
    (bddscoutStubsPtr->biddy_AvgLevel) /* 104 */
#define Biddy_Managed_VariableTableNum \
    (bddscoutStubsPtr->biddy_Managed_VariableTableNum) /* 105 */
#define Biddy_Managed_NodeTableSize \
    (bddscoutStubsPtr->biddy_Managed_NodeTableSize) /* 106 */
#define Biddy_Managed_NodeTableBlockNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableBlockNumber) /* 107 */
#define Biddy_Managed_NodeTableGenerated \
    (bddscoutStubsPtr->biddy_Managed_NodeTableGenerated) /* 108 */
#define Biddy_Managed_NodeTableMax \
    (bddscoutStubsPtr->biddy_Managed_NodeTableMax) /* 109 */
#define Biddy_Managed_NodeTableNum \
    (bddscoutStubsPtr->biddy_Managed_NodeTableNum) /* 110 */
#define Biddy_Managed_NodeTableNumVar \
    (bddscoutStubsPtr->biddy_Managed_NodeTableNumVar) /* 111 */
#define Biddy_Managed_NodeTableResizeNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableResizeNumber) /* 112 */
#define Biddy_Managed_NodeTableFoaNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableFoaNumber) /* 113 */
#define Biddy_Managed_NodeTableFindNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableFindNumber) /* 114 */
#define Biddy_Managed_NodeTableCompareNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableCompareNumber) /* 115 */
#define Biddy_Managed_NodeTableAddNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableAddNumber) /* 116 */
#define Biddy_Managed_NodeTableGCNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableGCNumber) /* 117 */
#define Biddy_Managed_NodeTableGCTime \
    (bddscoutStubsPtr->biddy_Managed_NodeTableGCTime) /* 118 */
#define Biddy_Managed_NodeTableGCObsoleteNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableGCObsoleteNumber) /* 119 */
#define Biddy_Managed_NodeTableSwapNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableSwapNumber) /* 120 */
#define Biddy_Managed_NodeTableSiftingNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableSiftingNumber) /* 121 */
#define Biddy_Managed_NodeTableDRTime \
    (bddscoutStubsPtr->biddy_Managed_NodeTableDRTime) /* 122 */
#define Biddy_Managed_NodeTableITENumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableITENumber) /* 123 */
#define Biddy_Managed_NodeTableITERecursiveNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableITERecursiveNumber) /* 124 */
#define Biddy_Managed_NodeTableANDORNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableANDORNumber) /* 125 */
#define Biddy_Managed_NodeTableANDORRecursiveNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableANDORRecursiveNumber) /* 126 */
#define Biddy_Managed_NodeTableXORNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableXORNumber) /* 127 */
#define Biddy_Managed_NodeTableXORRecursiveNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableXORRecursiveNumber) /* 128 */
#define Biddy_Managed_FormulaTableNum \
    (bddscoutStubsPtr->biddy_Managed_FormulaTableNum) /* 129 */
#define Biddy_Managed_ListUsed \
    (bddscoutStubsPtr->biddy_Managed_ListUsed) /* 130 */
#define Biddy_Managed_ListMaxLength \
    (bddscoutStubsPtr->biddy_Managed_ListMaxLength) /* 131 */
#define Biddy_Managed_ListAvgLength \
    (bddscoutStubsPtr->biddy_Managed_ListAvgLength) /* 132 */
#define Biddy_Managed_OPCacheSearch \
    (bddscoutStubsPtr->biddy_Managed_OPCacheSearch) /* 133 */
#define Biddy_Managed_OPCacheFind \
    (bddscoutStubsPtr->biddy_Managed_OPCacheFind) /* 134 */
#define Biddy_Managed_OPCacheInsert \
    (bddscoutStubsPtr->biddy_Managed_OPCacheInsert) /* 135 */
#define Biddy_Managed_OPCacheOverwrite \
    (bddscoutStubsPtr->biddy_Managed_OPCacheOverwrite) /* 136 */
#define Biddy_Managed_CountNodesPlain \
    (bddscoutStubsPtr->biddy_Managed_CountNodesPlain) /* 137 */
#define Biddy_Managed_DependentVariableNumber \
    (bddscoutStubsPtr->biddy_Managed_DependentVariableNumber) /* 138 */
#define Biddy_Managed_CountComplementedEdges \
    (bddscoutStubsPtr->biddy_Managed_CountComplementedEdges) /* 139 */
#define Biddy_Managed_CountPaths \
    (bddscoutStubsPtr->biddy_Managed_CountPaths) /* 140 */
#define Biddy_Managed_CountMinterms \
    (bddscoutStubsPtr->biddy_Managed_CountMinterms) /* 141 */
#define Biddy_Managed_DensityOfFunction \
    (bddscoutStubsPtr->biddy_Managed_DensityOfFunction) /* 142 */
#define Biddy_Managed_DensityOfBDD \
    (bddscoutStubsPtr->biddy_Managed_DensityOfBDD) /* 143 */
#define Biddy_Managed_MinNodes \
    (bddscoutStubsPtr->biddy_Managed_MinNodes) /* 144 */
#define Biddy_Managed_MaxNodes \
    (bddscoutStubsPtr->biddy_Managed_MaxNodes) /* 145 */
#define Biddy_Managed_ReadMemoryInUse \
    (bddscoutStubsPtr->biddy_Managed_ReadMemoryInUse) /* 146 */
#define Biddy_Managed_PrintInfo \
    (bddscoutStubsPtr->biddy_Managed_PrintInfo) /* 147 */

#define Biddy_Managed_Eval0 \
    (bddscoutStubsPtr->biddy_Managed_Eval0) /* 148 */
#define Biddy_Managed_Eval1x \
    (bddscoutStubsPtr->biddy_Managed_Eval1x) /* 149 */
#define Biddy_Managed_Eval2 \
    (bddscoutStubsPtr->biddy_Managed_Eval2) /* 150 */
#define Biddy_Managed_ReadBddview\
    (bddscoutStubsPtr->biddy_Managed_ReadBddview) /* 151 */
#define Biddy_Managed_ReadVerilogFile\
    (bddscoutStubsPtr->biddy_Managed_ReadVerilogFile) /* 152 */
#define Biddy_Managed_PrintfBDD\
    (bddscoutStubsPtr->biddy_Managed_PrintfBDD) /* 153 */
#define Biddy_Managed_WriteBDD \
    (bddscoutStubsPtr->biddy_Managed_WriteBDD) /* 154 */
#define Biddy_Managed_PrintfTable \
    (bddscoutStubsPtr->biddy_Managed_PrintfTable) /* 155 */
#define Biddy_Managed_WriteTable \
    (bddscoutStubsPtr->biddy_Managed_WriteTable) /* 156 */
#define Biddy_Managed_PrintfSOP \
    (bddscoutStubsPtr->biddy_Managed_PrintfSOP) /* 157 */
#define Biddy_Managed_WriteSOP \
    (bddscoutStubsPtr->biddy_Managed_WriteSOP) /* 158 */
#define Biddy_Managed_WriteDot \
    (bddscoutStubsPtr->biddy_Managed_WriteDot) /* 159 */
#define Biddy_Managed_WriteBddview \
    (bddscoutStubsPtr->biddy_Managed_WriteBddview) /* 160 */
