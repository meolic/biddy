...
typedef struct BddscoutStubs {
    ...
    unsigned int (*biddy_Managed_CountNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 112 */
    unsigned int (*biddy_MaxLevel) (Biddy_Edge f); /* 113 */
    float (*biddy_AvgLevel) (Biddy_Edge f); /* 114 */
    unsigned int (*biddy_Managed_SystemStat) (Biddy_Manager MNG, unsigned int stat); /* 115 */
    unsigned long long int (*biddy_Managed_SystemLongStat) (Biddy_Manager MNG, unsigned int longstat); /* 116 */
    unsigned int (*biddy_Managed_NodeTableNumVar) (Biddy_Manager MNG, Biddy_Variable v); /* 117 */
    unsigned long long int (*biddy_Managed_NodeTableGCObsoleteNumber) (Biddy_Manager MNG); /* 118 */
    unsigned int (*biddy_Managed_ListUsed) (Biddy_Manager MNG); /* 119 */
    unsigned int (*biddy_Managed_ListMaxLength) (Biddy_Manager MNG); /* 120 */
    float (*biddy_Managed_ListAvgLength) (Biddy_Manager MNG); /* 121 */
    unsigned int (*biddy_Managed_CountNodesPlain) (Biddy_Manager MNG, Biddy_Edge f); /* 122 */
    unsigned int (*biddy_Managed_DependentVariableNumber) (Biddy_Manager MNG, Biddy_Edge f, Biddy_Boolean select); /* 123 */
    unsigned int (*biddy_Managed_CountComplementedEdges) (Biddy_Manager MNG, Biddy_Edge f); /* 124 */
    unsigned long long int (*biddy_Managed_CountPaths) (Biddy_Manager MNG, Biddy_Edge f); /* 125 */
    double (*biddy_Managed_CountMinterms) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 126 */
    double (*biddy_Managed_DensityOfFunction) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 127 */
    double (*biddy_Managed_DensityOfBDD) (Biddy_Manager MNG, Biddy_Edge f, unsigned int nvars); /* 128 */
    unsigned int (*biddy_Managed_MinNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 129 */
    unsigned int (*biddy_Managed_MaxNodes) (Biddy_Manager MNG, Biddy_Edge f); /* 130 */
    unsigned long long int (*biddy_Managed_ReadMemoryInUse) (Biddy_Manager MNG); /* 131 */
    void (*biddy_Managed_PrintInfo) (Biddy_Manager MNG, FILE *f); /* 132 */
    Biddy_String (*biddy_Managed_Eval0) (Biddy_Manager MNG, Biddy_String s); /* 133 */
    Biddy_Edge (*biddy_Managed_Eval1x) (Biddy_Manager MNG, Biddy_String s, Biddy_LookupFunction lf); /* 134 */
    Biddy_Edge (*biddy_Managed_Eval2) (Biddy_Manager MNG, Biddy_String boolFunc); /* 135 */
    Biddy_String (*biddy_Managed_ReadBddview) (Biddy_Manager MNG, const char filename[], Biddy_String name); /* 136 */
    void (*biddy_Managed_ReadVerilogFile) (Biddy_Manager MNG, const char filename[], Biddy_String prefix); /* 137 */
    void (*biddy_Managed_PrintBDD) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f, Biddy_String label); /* 138 */
    void (*biddy_Managed_PrintTable) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f); /* 139 */
    void (*biddy_Managed_PrintSOP) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f); /* 140 */
    void (*biddy_Managed_PrintMinterms) (Biddy_Manager MNG, Biddy_String *var, const char filename[], Biddy_Edge f, Biddy_Boolean negative); /* 141 */
    ...
    unsigned int (*biddy_Managed_WriteBddview) (Biddy_Manager MNG, const char filename[], Biddy_Edge f, const char label[], void *table); /* 143 */
...
#define Biddy_Managed_CountNodes \
    (bddscoutStubsPtr->biddy_Managed_CountNodes) /* 112 */
#define Biddy_MaxLevel \
    (bddscoutStubsPtr->biddy_MaxLevel) /* 113 */
#define Biddy_AvgLevel \
    (bddscoutStubsPtr->biddy_AvgLevel) /* 114 */
#define Biddy_Managed_SystemStat \
    (bddscoutStubsPtr->biddy_Managed_SystemStat) /* 115 */
#define Biddy_Managed_SystemLongStat \
    (bddscoutStubsPtr->biddy_Managed_SystemLongStat) /* 116 */
#define Biddy_Managed_NodeTableNumVar \
    (bddscoutStubsPtr->biddy_Managed_NodeTableNumVar) /* 117 */
#define Biddy_Managed_NodeTableGCObsoleteNumber \
    (bddscoutStubsPtr->biddy_Managed_NodeTableGCObsoleteNumber) /* 118 */
#define Biddy_Managed_ListUsed \
    (bddscoutStubsPtr->biddy_Managed_ListUsed) /* 119 */
#define Biddy_Managed_ListMaxLength \
    (bddscoutStubsPtr->biddy_Managed_ListMaxLength) /* 120 */
#define Biddy_Managed_ListAvgLength \
    (bddscoutStubsPtr->biddy_Managed_ListAvgLength) /* 121 */
#define Biddy_Managed_CountNodesPlain \
    (bddscoutStubsPtr->biddy_Managed_CountNodesPlain) /* 122 */
...
#define Biddy_Managed_CountComplementedEdges \
    (bddscoutStubsPtr->biddy_Managed_CountComplementedEdges) /* 124 */
#define Biddy_Managed_CountPaths \
    (bddscoutStubsPtr->biddy_Managed_CountPaths) /* 125 */
#define Biddy_Managed_CountMinterms \
    (bddscoutStubsPtr->biddy_Managed_CountMinterms) /* 126 */
#define Biddy_Managed_DensityOfFunction \
    (bddscoutStubsPtr->biddy_Managed_DensityOfFunction) /* 127 */
#define Biddy_Managed_DensityOfBDD \
    (bddscoutStubsPtr->biddy_Managed_DensityOfBDD) /* 128 */
#define Biddy_Managed_MinNodes \
    (bddscoutStubsPtr->biddy_Managed_MinNodes) /* 129 */
#define Biddy_Managed_MaxNodes \
    (bddscoutStubsPtr->biddy_Managed_MaxNodes) /* 130 */
#define Biddy_Managed_ReadMemoryInUse \
    (bddscoutStubsPtr->biddy_Managed_ReadMemoryInUse) /* 131 */
#define Biddy_Managed_PrintInfo \
    (bddscoutStubsPtr->biddy_Managed_PrintInfo) /* 132 */

#define Biddy_Managed_Eval0 \
    (bddscoutStubsPtr->biddy_Managed_Eval0) /* 133 */
#define Biddy_Managed_Eval1x \
    (bddscoutStubsPtr->biddy_Managed_Eval1x) /* 134 */
#define Biddy_Managed_Eval2 \
    (bddscoutStubsPtr->biddy_Managed_Eval2) /* 135 */
#define Biddy_Managed_ReadBddview\
    (bddscoutStubsPtr->biddy_Managed_ReadBddview) /* 136 */
#define Biddy_Managed_ReadVerilogFile\
    (bddscoutStubsPtr->biddy_Managed_ReadVerilogFile) /* 137 */
#define Biddy_Managed_PrintBDD\
    (bddscoutStubsPtr->biddy_Managed_PrintBDD) /* 138 */
#define Biddy_Managed_PrintTable \
    (bddscoutStubsPtr->biddy_Managed_PrintTable) /* 139 */
#define Biddy_Managed_PrintSOP \
    (bddscoutStubsPtr->biddy_Managed_PrintSOP) /* 140 */
#define Biddy_Managed_PrintMinterms \
    (bddscoutStubsPtr->biddy_Managed_PrintMinterms) /* 141 */
